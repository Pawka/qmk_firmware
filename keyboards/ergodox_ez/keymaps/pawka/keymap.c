...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_RALT,                                        KC_RALT,        KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLASH,
    ...
    KC_TRANSPARENT, KC_LGUI,        KC_LALT,        KC_TRANSPARENT, OSL(3),                                                                                                         LT(1,KC_NO),    KC_RALT,        KC_LBRACKET,    KC_RBRACKET,    KC_RCTRL,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,                                                                       KC_TRANSPARENT, KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_F12,
