...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_ESCAPE,      LGUI_T(KC_Q),   LALT_T(KC_W),   LCTL_T(KC_E),   LSFT_T(KC_R),   KC_T,           KC_TRANSPARENT,                                 TG(5),          KC_Y,           RSFT_T(KC_U),   RCTL_T(KC_I),   LALT_T(KC_O),   RGUI_T(KC_P),   KC_BSLASH,
    ...
    KC_LCTRL,       KC_LGUI,        KC_LALT,        LT(1,KC_NO),    OSL(2),                                                                                                         LT(1,KC_NO),    KC_RALT,        KC_LBRACKET,    KC_RBRACKET,    KC_RCTRL,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_SPACE,       KC_BSPACE,      KC_TRANSPARENT, KC_TRANSPARENT, LT(3,KC_TAB),   KC_ENTER
  ),
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_PIPE,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_UNDS,        KC_7,           KC_8,           KC_9,           KC_ASTR,        KC_F11,
